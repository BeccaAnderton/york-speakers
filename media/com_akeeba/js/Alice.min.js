...
a.preventDefault():a.returnValue=!1;a=akeeba.System.data.get(this,"url");window.location=a.replace("[TAG]",c.options[c.selectedIndex].value)});akeeba.System.addEventListener(f,"click",function(a){a.preventDefault?a.preventDefault():a.returnValue=!1;if(1==akeeba.System.data.get(this,"started",!1))return!1;this.className="akeeba-btn--dark";akeeba.System.data.set(this,"started",!0);c.setAttribute("disabled","disabled");document.getElementById("alice-messages").innerHTML="";h.style.display="none";(new AkeebaStepper({onBeforeStart:function(a){var c=
document.getElementById("log");a.data.log=c.options[c.selectedIndex].value},onComplete:function(a){var e=[],q=document.getElementById("alice-messages");a=JSON.parse(a.Results);for(var r=Joomla.JText._("COM_AKEEBA_ALICE_SUCCESSS"),t=Joomla.JText._("COM_AKEEBA_ALICE_WARNING"),u=Joomla.JText._("COM_AKEEBA_ALICE_ERROR"),k=0;k<a.length;k++){var d=a[k],l=document.createElement("tr"),b="akeeba-label--success",m=r;d.result==AKEEBA_ANALYZE_WARNING?(m=t,b="akeeba-label--warning"):d.result==AKEEBA_ANALYZE_FAILURE&&
(m=u,b="akeeba-label--failure");var g=document.createElement("td");g.innerHTML=d.check;l.appendChild(g);var p=document.createElement("td"),n=document.createElement("span");n.className=b;n.innerHTML=m;p.appendChild(n);l.appendChild(p);d.result!=AKEEBA_ANALYZE_SUCCESS&&(e.push({check:d.raw.check,error:d.raw.error}),b=document.createElement("div"),b.className="akeeba-panel--red",g.appendChild(b),b=document.createElement("p"),b.innerHTML=d.error,g.appendChild(b),b=document.createElement("p"),b.innerHTML=
...
"------ BEGIN OF ALICE RAW OUTPUT -----\n",c=0;c<a.length;c++)d=a[c],b+="[b]"+d.check+"[/b]\n"+d.error+"\n\n";b+="------ END OF ALICE RAW OUTPUT -----\n";h.querySelector("textarea").innerHTML=b;h.style.display="block"}}})}})).init();return!1});akeeba.System.triggerEvent(c,"change");document.getElementById("log").options[document.getElementById("log").selectedIndex].value&&akeeba.System.triggerEvent(f,"click")}); //# sourceMappingURL=Alice.min.map
